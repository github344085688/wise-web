...
define(['./directives', 'lodash'], function(directives,_ ) {
    directives.directive('multipleOrganizationAutoComplete', ['$q', 'organizationService','lincUtil', function($q,organizationService,lincUtil) {
        return {
            restrict: "E",
            ...
            link: function($scope) {
                ...
                function initialOrganizationWithModel(){
                    ...
                    organizationService.getOrganizations({ids:$scope.ngModel}).then(function(data){
                        ...
                        organizationService.getOrganizationByTag(param).then(function(data1){
