...
define([
	...
	'lodash',
	'async',
	'async!https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDtFt9CIaNT-Y489y6Z8FDYB3PVbFoI0xA&libraries=geometry,visualization,drawing'
], function($, _){
	...
	Map.prototype.createPolylines =function(group, lines, style, options){
		...
		for(var i=0; i<lines.length; i++){
			...
			var polyline = createPolyline(strToPath(line.latlng), style, options);
