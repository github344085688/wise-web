...
define([], function () {
    var printPageController = function ($scope, $cookies, $stateParams, printService, lincUtil, transloadTaskService,loadsService) {
        $scope.print = function () {
            ...
            printService.generateBolPdfByShippingAddress($scope.loadId).then(function (data) {
        ...
        function init() {
            ...
            printService.generateBolPdfByShippingAddress($scope.loadId).then(function(res){
                $scope.data = '/file-app/file-view/' + res.fileId;
            }, function(err){
