...
define([
    ...
    var controller = function ($scope,  $http,  lincUtil, inventoryService) {
        ...
        $scope.loadContent = function (currentPage) {
            ...
            inventoryService.multiItemLocation(param).then(function (response) {
                $scope.loading = false;
        ...
        $scope.export = function() {
            ...
            $http.post("/report-center/location/multi-item-location/download", exportData, {
                ...
                lincUtil.exportFile(res, "multipleItemLocation.xlsx");
                $scope.exporting = false;
