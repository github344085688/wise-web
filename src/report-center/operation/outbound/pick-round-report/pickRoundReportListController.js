...
define(['angular', 'lodash'], function (angular, _) {
    var controller = function ($scope, lincUtil, reportService, $http) {
        $scope.pageSize = 10;
        ...
        $scope.loadContent = function (currentPage) {
            ...
            reportService.searchPickRoundReport(searchParam).then(function (response) {
        ...
        $scope.export = function () {
            ...
            $http.post("/report-center/outbound/pick-round-report/download", searchParam, {
                ...
                lincUtil.exportFile(res, "pickRoundReport.xlsx");
            }, function (error) {
    ...
    controller.$inject = ['$scope', 'lincUtil', 'reportService', '$http'];
    return controller;
});